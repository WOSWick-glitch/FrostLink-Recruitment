import { db } from "./db";
import { states, alliances, players, transferGroups } from "@shared/schema";
...
export async function seedDatabase() {
  ...
  await db.insert(transferGroups).values([
    {
      name: "Project Vanguard",
      status: "Forming",
      description: "Group of 15 players (1.2B total power) looking for a competitive state to take over.",
      leader: "FrostKing",
      memberCount: 15,
      totalPower: "1.2B",
    },
    {
      ...
      status: "Moving Soon",
      description: "Small group of 5 friends looking for a peaceful state with strong NAP rules.",
      leader: "SnowQueen",
      memberCount: 5,
      totalPower: "350M",
    },
